-- Criar função RPC para busca semântica de exercícios
-- Usa busca vetorial com embeddings OpenAI
...
COMMENT ON FUNCTION match_exercises IS 'Busca semântica de exercícios usando embeddings OpenAI. Retorna exercícios mais similares à query baseado em distância cosine.';
